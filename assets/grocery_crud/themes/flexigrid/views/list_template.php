...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv2">
			...
			<div class="fbutton">
				<div>
					<span class="add btn-input-general-blue"><?php echo $this->l('list_add'); ?> <?php echo $subject?></span>
				</div>
			</div>
            </a>
		...
		<div class="tDiv3">
        	...
        	<a class="export-anchor" href="<?php echo $export_url; ?>" download>
				<div class="fbutton">
					<div>
						<span class="export btn-input-general-icon"><?php echo $this->l('list_export');?></span>
					</div>
				</div>
            </a>
        	...
        	<a class="print-anchor" data-url="<?php echo $print_url; ?>">
				<div class="fbutton">
					<div>
						<span class="print btn-input-general"><?php echo $this->l('list_print');?></span>
					</div>
				</div>
            </a>
			<!-- <div class="btnseparator"></div> -->
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			<?php echo $this->l('list_search');?>: <input type="text" class="qsbsearch_fieldox search_text btn-input-general-text" name="search_text" size="30" id='search_text'>
			<select name="search_field" id="search_field" class="btn-select-general">
				<option value=""><?php echo $this->l('list_search_all');?></option>
				<?php foreach($columns as $column){?>
				<option value="<?php echo $column->field_name?>"><?php echo $column->display_as?>&nbsp;&nbsp;</option>
				<?php }?>
			</select>
            <input type="button" value="<?php echo $this->l('list_search');?>" class="crud_search btn-input-general" id='crud_search'>
		</div>
        <div class='search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="search_clear btn-input-general">
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
			<div class="pGroup">
				<span class="pcontrol">
					...
					<select name="per_page" id='per_page' class="per_page btn-select-general">
			...
			<div class="pGroup">
				<span class="pcontrol"><?php echo $this->l('list_page'); ?> <input name='page' type="text" value="1" size="4" id='crud_page' class="crud_page btn-input-general-text">
